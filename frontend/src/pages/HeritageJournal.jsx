...
const HeritageJournal = () => {
  ...
  return (
    <div className="bg-[#FCF9F6] min-h-screen pt-8 pb-40">
      {/* Journal Header - Centered Editorial */}
      <section className="max-w-4xl mx-auto px-6 md:px-12 mb-12 relative">
        <div className="flex flex-col items-center text-center gap-8 border-b border-outline-variant/10 pb-12">
